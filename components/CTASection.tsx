...
export default function CTASection() {
  return (
    <section className="landing-section landing-section--compact" aria-labelledby="cta-heading">
      <div className="landing-container">
        <div
          className="relative rounded-2xl overflow-hidden text-center px-6 py-10 sm:px-10 sm:py-12 max-w-3xl mx-auto"
          style={{
            background:
              "linear-gradient(135deg, rgba(0,245,255,0.06) 0%, rgba(5,5,16,0.96) 45%, rgba(255,0,128,0.04) 100%)",
            border: "1px solid rgba(0, 245, 255, 0.16)",
            boxShadow: "0 0 32px rgba(0, 245, 255, 0.05)",
          }}
        >
